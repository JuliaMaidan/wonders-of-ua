...
window.addEventListener("scroll", function() {
    ...
    if (scrolled > threshold) header.classList.add("scrolled"); // Додаємо клас, який змінює фон
    else header.classList.remove("scrolled"); // Видаляємо клас при поверненні до початкового положення
});
